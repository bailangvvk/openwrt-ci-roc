...
git_sparse_clone main https://github.com/kenzok8/small-package adguardhome luci-app-adguardhome v2dat mosdns luci-app-mosdns luci-app-istorex luci-app-natter2
